...
def load_live_sido_table():
    ...
    center_map = [{"lat": 38.00, "lon": 128.22}, {"lat": 37.45, "lon": 126.70}, {"lat": 35.16, "lon": 126.85},
                  ...
                  {"lat": 35.45, "lon": 127.15}, {"lat": 35.15, "lon": 128.15}, {"lat": 36.25, "lon": 127.17},
...
def load_addpop():
    ...
    addpop_df = addpop_df[addpop_df['datetime'] > '2022-05-01']
